...
<html>
	...
	<table id="zipcode">
		...
		<tr>
			<td>${dongList.zipNum}</td>
			<td>
				<a href="#" onclick="return result('${dongList.zipNum}', '${dongList.sido}', '${dongList.gugun}','${dongList.dong}')">
					${dongList.sido} ${dongList.gugun} ${dongList.dong}
				</a>
			</td>
		</tr>
		</c:forEach>
